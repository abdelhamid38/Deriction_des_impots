 ...
 * @author Abdelhamid
 */
public class ViewFactureController implements Initializable {
    ...
    @FXML
    private JFXButton Parcourir,learn;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        learn.addEventHandler(MouseEvent.MOUSE_CLICKED,e->{
            ...
            CreateDataset.addtoCsv((int) imageView.getFitWidth(), (int) zone.getWidth(),"C:\\Users\\Abdelhamid\\Documents\\NetBeansProjects\\Deriction_des_impots\\src\\Dataset\\G51\\Dataset\\"+fieldname+"\\Width.csv");
            CreateDataset.addtoCsv((int) imageView.getFitWidth(), (int) zone.getX(),"C:\\Users\\Abdelhamid\\Documents\\NetBeansProjects\\Deriction_des_impots\\src\\Dataset\\G51\\Dataset\\"+fieldname+"\\Xoffset.csv");
            CreateDataset.addtoCsv((int) imageView.getFitHeight(), (int) zone.getHeight(),"C:\\Users\\Abdelhamid\\Documents\\NetBeansProjects\\Deriction_des_impots\\src\\Dataset\\G51\\Dataset\\"+fieldname+"\\Height.csv");
            CreateDataset.addtoCsv((int) imageView.getFitHeight(), (int) zone.getY(),"C:\\Users\\Abdelhamid\\Documents\\NetBeansProjects\\Deriction_des_impots\\src\\Dataset\\G51\\Dataset\\"+fieldname+"\\Yoffset.csv");
